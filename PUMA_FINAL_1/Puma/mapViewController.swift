...
class mapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    //Label que indica qué ruta seleccionó el usuario
    @IBOutlet weak var textoRuta: UILabel!
    ...
    func trazarRutaUno()
    {
        textoRuta.text = "RUTA 1"
        textoRuta.backgroundColor = UIColor(hex: "#82e0aa")
        limpiarPantalla()
    ...
    func trazarRutaDos()
    {
        textoRuta.text = "RUTA 2"
        textoRuta.backgroundColor = UIColor(hex: "#f4d03f")
       limpiarPantalla()
    ...
    func trazarRutaTres()
    {
        textoRuta.text = "RUTA 3"
        textoRuta.backgroundColor = UIColor(hex: "#0e6655")
        limpiarPantalla()
    ...
    {
        textoRuta.text = "RUTA 4"
        textoRuta.backgroundColor = UIColor(hex: "#4b4b4b")
        limpiarPantalla()
    ...
    {
        textoRuta.text = "RUTA 5"
        textoRuta.backgroundColor = UIColor(hex: "#3498db")
        limpiarPantalla()
    ...
    func trazarRutaSeis()
    {
        textoRuta.text = "RUTA 6"
        textoRuta.backgroundColor = UIColor(hex: "#e67e22")
        limpiarPantalla()
    ...
    {
        textoRuta.text = "RUTA 7"
        textoRuta.backgroundColor = UIColor(hex: "#d4ac0d")
        limpiarPantalla()
    ...
    func trazarRutaOcho()
    {
        textoRuta.text = "RUTA 8"
        textoRuta.backgroundColor = UIColor(hex: "#34495e")
        limpiarPantalla()
    ...
    {
        textoRuta.text = "RUTA 9"
        textoRuta.backgroundColor = UIColor(hex: "#7b241c")
        limpiarPantalla()
    ...
    func trazarRutaDiez()
    {
        textoRuta.text = "RUTA 10"
        textoRuta.backgroundColor = UIColor(hex: "#000000")
        limpiarPantalla()
    ...
    func trazarRutaOnce()
    {
        textoRuta.text = "RUTA 11"
        textoRuta.backgroundColor = UIColor(hex: "#512e5f")
        limpiarPantalla()
